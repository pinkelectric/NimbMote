...
const features = [
  ...
  { icon: PanelsTopLeft, title: 'Play/Pause in Quick Settings', text: 'Keep a one-tap NimbMote control beside Wi-Fi and Bluetooth, even after Android hides the media card.' },
  { icon: ShieldCheck, title: 'Paired on your network', text: 'NimbMote connects your phone and PC over the same Wi-Fi with a six-digit pairing code.' },
];
    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <p className="hero-text">NimbMote turns your Android phone into a calm, private remote for the Windows PC already in your room.</p>
          <div className="hero-actions">
            <Button className="primary-action" render={<a href="#downloads" />}>Get NimbMote <ArrowDownToLine /></Button>
        ...
        <div className="hero-visual" aria-label="NimbMote Android app screenshot">
          <div className="glow glow-violet" /><div className="glow glow-coral" />
          <div className="phone-shell"><img src="/screenshots/deskora-main.jpg" alt="NimbMote showing a connected Dell computer and media controls" /></div>
      ...
      <section className="section section-muted" id="how-it-works">
        ...
        <div className="steps">
          <article><span className="step-number">01</span><MonitorSmartphone /><h3>Install the Windows Agent</h3><p>Install NimbMote Agent on the computer you want to control. On first launch it shows a six-digit code.</p></article>
          <article><span className="step-number">02</span><Smartphone /><h3>Install NimbMote on Android</h3><p>Open the app on your phone. The current Android package is a test build until the Google Play release.</p></article>
          <article><span className="step-number">03</span><LockKeyhole /><h3>Enter the code once</h3><p>Enter the code while both devices share Wi-Fi. NimbMote remembers the protected pairing afterwards.</p></article>
        </div>
      </section>
